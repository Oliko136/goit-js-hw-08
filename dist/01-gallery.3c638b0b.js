...
renderGallery((0, _galleryItems.galleryItems));
var lightbox = new (0, _simplelightboxDefault.default)(".gallery__item", {
    captionsData: "alt",
    captionDelay: 250
});
function renderGallery(items) {
    const markup = items.map(({ preview , original , description  })=>`<div><a class="gallery__item" href=${original}>
...
},{}],"kaxSc":[function() {},{}]},["a1WKf","9de4I"], "9de4I", "parcelRequired7c6")
